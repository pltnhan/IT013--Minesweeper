...
public class FaceJPanel extends JPanel {
    ...
    private void init() {
        ...
        Icon icon0 = new ImageIcon("src/resources/d0.gif");
        Icon icon1 = new ImageIcon("src/resources/d" + StaticTool.allcount / 10
                + ".gif");
        Icon icon2 = new ImageIcon("src/resources/d" + StaticTool.allcount % 10
                + ".gif");
        Icon iconSmile = new ImageIcon("src/resources/face0.gif");
